...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__popup_popup_tag_html__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__popup_popup_tag_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__popup_popup_tag_html__);

    var riot = __webpack_require__(0)
    //src: C:/dev/outsource/pdf-img-viewer-uploader/src/popup/app.tag.html

riot.tag2('app',
  '<header>Popup</header> <button class="fa fa-file" type="button" onclick="{clickOpenPopup}"> Open Popup</button> <footer>Trust ID 2017</footer> <popup> <h2>Ok I\'m open</h2> <p> Try pusing the close button </p> </popup>',
  '',
  '', function(opts) {
